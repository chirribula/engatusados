                ...
                <form action="" method="POST" enctype="multipart/form-data" style="height: 600px">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" class="form-control" id="precio" class="form-control @error('precio') is-invalid @enderror" name="precio" value="{{ old('precio') }}"  autocomplete="precio" placeholder="Pprecio del producto"required>
                            @error('precio')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <button type="submit" name="submit" class="btn btn-info">Insertar Producto</button>
                </form>
            </div>
